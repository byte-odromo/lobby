    ...
    io.on('connection', function( socket ) {
        ...
        socket.on('joinRoom', function( guess ) {
            ...
            if( app.roomList[ guess.roomId ] ){
                ...
                socket.roomId = guess.roomId;
                socket.userId = guess.userId;
                app.roomList[ guess.roomId ].push( guess.userId );
                ...
                socket.broadcast.to( guess.roomId ).emit('newJoinRoom', { id: guess.userId });
            }
        });
        ...
        socket.on( 'game' , function( data ) {
            io.sockets.to(socket.roomId).emit('game', {userId: socket.userId, data: data});
        });
